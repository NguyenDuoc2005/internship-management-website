<template>
    <div class="bg-gray-200 bg-cover min-h-screen flex justify-center items-center px-4 sm:px-6 lg:px-8"
        ...
        <div class="card border-0 w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl">
            ...
            <router-link :to="{ name: ROUTES_CONSTANTS.REGISTER.name }">
...
import { URL_OAUTH2_GOOGLE_ADMIN, URL_OAUTH2_GOOGLE_ADMIN_REGISTER, URL_OAUTH2_GOOGLE_MANAGE, URL_OAUTH2_GOOGLE_MANAGE_REGISTER, URL_OAUTH2_GOOGLE_MEMBER, URL_OAUTH2_GOOGLE_MEMBER_REGISTER } from '@/constants/url';
...
const backgroundImageUrl = 'https://i.pinimg.com/originals/c2/e9/02/c2e902e031e1d9d932411dd0b8ab5eef.jpg';
const adminImageUrl = 'https://icon-library.com/images/admin-user-icon/admin-user-icon-3.jpg';
const manageImageUrl = 'https://cdn-icons-png.flaticon.com/512/4873/4873262.png';
const memberImageUrl = 'https://icon-library.com/images/admin-user-icon/admin-user-icon-3.jpg';
...
const handleRedirectLoginADMIN = () => {
    window.location.href = URL_OAUTH2_GOOGLE_ADMIN_REGISTER();
};
